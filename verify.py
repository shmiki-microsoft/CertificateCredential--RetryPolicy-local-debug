...
主な環境変数:
    ...
    RETRY_TOTAL, RETRY_CONNECT, RETRY_READ, RETRY_BACKOFF_FACTOR, RETRY_BACKOFF_MAX,
...
class Config:
    ...
    def from_env(cls) -> "Config":
        ...
        return cls(
            ...
            retry_total=_getenv_int("RETRY_TOTAL", 4),
            retry_connect=_getenv_int("RETRY_CONNECT", 4),
            retry_read=_getenv_int("RETRY_READ", 4),
            retry_backoff_factor=_getenv_float("RETRY_BACKOFF_FACTOR", 20.0),
            retry_backoff_max=_getenv_float("RETRY_BACKOFF_MAX", 20.0),
...
def print_header(cfg: Config) -> None:
    ...
    if cfg.enable_retry:
        print(f"  [azure.core] retry_total={cfg.retry_total} retry_connect={cfg.retry_connect} "
              f"retry_read={cfg.retry_read} backoff_factor={cfg.retry_backoff_factor} "
              f"backoff_max={cfg.retry_backoff_max}")
